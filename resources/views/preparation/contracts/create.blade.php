    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <form autocomplete="off" method="POST" action="{{route('preparation.contracts.store')}}">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="contract_type" name="contract_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                       placeholder="Full-Time" required>
            </div>

                <div class="mb-6">
                    <label for="hours_per_week" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hours/Week</label>
                    <input type="text" id="hours_per_week" name="hours_per_week" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="38.5" required>
                </div>

            <div class="mb-6">
                <label for="min_shift_length" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Min. Shift Length</label>
                <input type="text" id="min_shift_length" name="min_shift_length" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                       placeholder="8" required>
            </div>

                <div class="mb-6">
                    <label for="break_length" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Break Length per Shift</label>
                    <input type="text" id="break_length" name="break_length" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
