        ...
        <form autocomplete="off" method="POST" action="{{url('/contract/'.$contract->id.'/update')}}">
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('min_shift_length'))
                    <input type="number" value="{{$contract->min_hours_per_shift + 0}}" min="1" max="48" id="min_shift_length"  name="min_shift_length" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="8" required>
                    <span class="text-red-500">{{ $errors->first('min_shift_length') }}</span>
                @else
                    <input type="number" value="{{$contract->min_hours_per_shift + 0}}" min="1" max="48" id="min_shift_length" name="min_shift_length" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="8" required>
                @endif
            </div>
