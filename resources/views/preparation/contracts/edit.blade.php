<x-app-layout>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <form autocomplete="off" method="POST" action="{{url('/contract/'.$contract->id.'/update')}}">
            @csrf
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('hours_per_week'))
                    <input type="number" value="{{$contract->max_hours_per_week + 0}}" max="120" step="0.01" id="hours_per_week" name="hours_per_week" class="bg-red-100 border border-red-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-red-200 dark:border-red-500 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-purple-500 dark:focus:border-purple-500"
                           placeholder="38.5" required>
                    <span class="text-red-500">{{ $errors->first('hours_per_week') }}</span>
                @else
                    <input type="number" value="{{$contract->max_hours_per_week + 0}}" max="120" step="0.01" id="hours_per_week" name="hours_per_week" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                           placeholder="38.5" required>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('days_of_vacation_per_year'))
                    <input type="number" value="{{$contract->days_of_vacation_per_year}}" id="days_of_vacation_per_year" name="days_of_vacation_per_year" class="bg-red-100 border border-red-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-red-200 dark:border-red-500 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-purple-500 dark:focus:border-purple-500"
                           placeholder="8" required>
                    <span class="text-red-500">{{ $errors->first('days_of_vacation_per_year') }}</span>
                @else
                    <input type="number" value="{{$contract->days_of_vacation_per_year}}" id="days_of_vacation_per_year" name="days_of_vacation_per_year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('break_length'))
                    <input type="number" value="{{$contract->break_length_in_minutes}}" id="break_length" name="break_length" class="bg-red-100 border border-red-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-red-200 dark:border-red-500 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-purple-500 dark:focus:border-purple-500"
                           placeholder="Minutes" required>
                    <span class="text-red-500">{{ $errors->first('break_length') }}</span>
                @else
                    <input type="number" value="{{$contract->break_length_in_minutes}}" id="break_length" name="break_length" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                           placeholder="Minutes" required>
                @endif
            </div>

            <label class="relative inline-flex items-center mb-4 cursor-pointer">
                <input type="checkbox" @if($contract->break_included == "on") checked @endif name="break_included" id="break_included" class="sr-only peer">
