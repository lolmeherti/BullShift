        ...
        <form autocomplete="off" method="POST" action="{{url('/contract/'.$contract->id.'/update')}}">
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('contract_type'))
                    <input type="text" id="contract_type" value="{{$contract->contract_type}}" maxlength="70" name="contract_type" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="Full-Time" required>
                    <span class="text-red-500">{{ $errors->first('contract_type') }}</span>
                @else
                    <input type="text" id="contract_type" value="{{$contract->contract_type}}" maxlength="70" name="contract_type" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="Full-Time" required>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('hours_per_week'))
                    <input type="number" value="{{$contract->max_hours_per_week + 0}}" max="120" step="0.01" id="hours_per_week" name="hours_per_week" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="38.5" required>
                    <span class="text-red-500">{{ $errors->first('hours_per_week') }}</span>
                @else
                    <input type="number" value="{{$contract->max_hours_per_week + 0}}" max="120" step="0.01" id="hours_per_week" name="hours_per_week" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="38.5" required>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('min_shift_length'))
                    <input type="number" value="{{$contract->min_hours_per_shift + 0}}" min="1" max="48" step="0.01" id="min_shift_length"  name="min_shift_length" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="8" required>
                    <span class="text-red-500">{{ $errors->first('min_shift_length') }}</span>
                @else
                    <input type="number" value="{{$contract->min_hours_per_shift + 0}}" min="1" max="48" step="0.01" id="min_shift_length" name="min_shift_length" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="8" required>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('days_of_vacation_per_year'))
                    <input type="number" value="{{$contract->days_of_vacation_per_year}}" id="days_of_vacation_per_year" name="days_of_vacation_per_year" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="8" required>
                    <span class="text-red-500">{{ $errors->first('days_of_vacation_per_year') }}</span>
                @else
                    <input type="number" value="{{$contract->days_of_vacation_per_year}}" id="days_of_vacation_per_year" name="days_of_vacation_per_year" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('break_length'))
                    <input type="number" value="{{$contract->break_length_in_minutes}}" id="break_length" name="break_length" class="{{$alertFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="Minutes" required>
                    <span class="text-red-500">{{ $errors->first('break_length') }}</span>
                @else
                    <input type="number" value="{{$contract->break_length_in_minutes}}" id="break_length" name="break_length" class="{{$normalFormInputTheme}} text-sm rounded-lg block w-full p-2.5"
                           placeholder="Minutes" required>
                @endif
            </div>
