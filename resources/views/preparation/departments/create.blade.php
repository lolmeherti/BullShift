        ...
        <form autocomplete="off" method="POST" action="{{route('preparation.departments.store')}}">
            ...
            <div class="mb-6">
                ...
                @if ($errors->has('department'))
                    <input type="text" id="department" value="{{old('department')}}" maxlength="70" name="department"
            ...
            <div id="dropdownSearch" class="z-10 hidden bg-white rounded-lg shadow w-60 dark:bg-gray-700 border border-gray-400">
                <div class="p-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value="" id="input-group-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="Search user">
                    </div>
                </div>
            ...
            <div style="justify-self: end;" id="button" class="col-start-2 col-end-3 justify-items-end py-4">
                <button type="submit" onclick="showCreatingDepartmentInProgress()"
